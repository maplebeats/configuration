...
tags_name = { 1, "0", "7", "9", "8-Play", "P-Chat", "U-WEB", "I-EDIT", "O-TERM", "Blank"}
tags_layout = {
  awful.layout.suit.tile,
  awful.layout.suit.tile,
  awful.layout.suit.tile,
...
cputempwidget_clock:add_signal("timeout", function()
    ...
    if fc and tonumber(fc:match('%d+')) > 79 then
        naughty.notify({title="警告", timeout=5,text="CPU 温度已超过 79℃！", preset=naughty.config.presets.critical})
    end
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "t",      function () awful.util.spawn("terminal") end),--function (c) c.ontop = not c.ontop            end),
    awful.key({ modkey,           }, "n",
        function (c)
...
for i = 1, keynumber do
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey,    }, "1", function () awful.tag.viewonly(tags[1][1])    end),
        awful.key({ modkey,    }, "0", function () awful.tag.viewonly(tags[1][2])    end),
        awful.key({ modkey,    }, "7", function () awful.tag.viewonly(tags[1][3])    end),
        awful.key({ modkey,    }, "9", function () awful.tag.viewonly(tags[1][4])    end),
        awful.key({ modkey,    }, "8", function () awful.tag.viewonly(tags[1][5])   end),
        awful.key({ modkey,    }, "p", function () awful.tag.viewonly(tags[1][6])   end),
        awful.key({ modkey,    }, "u", function () awful.tag.viewonly(tags[1][7])   end),
        awful.key({ modkey,    }, "i", function () awful.tag.viewonly(tags[1][8])   end),
        awful.key({ modkey,    }, "o", function () awful.tag.viewonly(tags[1][9])   end),
...
{ 
    ...
    "dropboxd",
    "thunar --daemon",
    "python2 /home/maplebeats/Software/goagent/local/proxy.py"
}
